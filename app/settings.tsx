...
export default function Settings() {
  ...
  async function toggle(value: boolean) {
    ...
    router.back(); // pop back to Weather 
  }
 
  // Return screen to user to show settings
  return (
    <ImageBackground //put everything in this background
    ...
    >
        ...
        <View className="my-60 mx-6 flex-1 justify-center items-center bg-[rgba(0,0,0,0.6)] rounded-2xl">
            ...
            <Switch  value={isMetric} onValueChange={toggle} thumbColor="#00b4d8" /> //switch betwen celcius and Fahrenheit
        </View>
    </ImageBackground>
  );
}
